...
import illustration from 'assets/images/banner-bg.jpg';
      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            ...
            <Text as="p">
            Deste Pequeno almoço, Lanches , Reuniões, Baptizado, Aniversários, Casamentos  e Muto Mais .
            </Text>
            <SubscriptionForm sx={styles.subscriptionForm} buttonLabel={'Enviar'} />
