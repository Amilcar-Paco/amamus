...
import support from 'assets/images/team.jpg';

const list = [
  'Chamussas',
  'Rissóis',
  'Bolinhas de Mandioca',
  'Almofadadinhas',
  'Folhados',
  'Mini Pizzas',
  'Bolos',
        ...
        <Box sx={styles.grid}>
          ...
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
              Prestamos serviços de catering  para qualquer  tipo de evento.
            </Heading>
            <Text as="p" sx={styles.summary}>
              Temos o menu semanal  servido entre Maputo e matola. As encomendas  são feitas com um dia de antecedência .
            </Text>
