...
import illustration from 'assets/images/tania.jpg';
          ...
          <div sx={styles.content}>
            <div sx={styles.heading}>
              <Heading sx={styles.title}>
                "Ser Pessoa com Deficiência não é  algo fácil."
              </Heading>
              <Text as="p" style={{ textAlign: 'justify' }}>
                A sociedade  não nos aceita e não nos acolhe como pessoas que merecem ser tratadas normalmente.
              </Text>
              <Text as="p" sx={styles.summary} style={{ textAlign: 'justify' }}>
                A minha audição  cria barreiras em alguns momentos  principalmente  na comunicação  por telefone pois nem todos têm a paciência  de escrever um sms mesmo quando pedimos que o faça explicando o motivo. Mas nada me impede de lutar  e ir mais adiante .

              </Text>
              <Text as="p" style={{ textAlign: 'justify' }}>
                Empreendedorismo  não é algo fácil de se fazer.  Requer muito de nós, principalmente  quando iniciamos sem nenhum apoio . Sinto que até aqui já dei uma passo enorme .  Quando decidimos que não existem barreiras  e temos metas por alcancar ,nada nos trava.  Sinto-me feliz  por poder fazer o que faço e me sentir útil na sociedade
              </Text>
            </div>
            {/* <SectionHeading
              sx={styles.heading}
